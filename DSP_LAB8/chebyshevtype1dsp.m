function  [N,Pole,a,b]= chebyshevtype1dsp(Ap,As,Fp,Fs,F_b,Filter_type,Ts)
%% Required Filter Design of LPF Prototype %%
    ...
    %magintude plot of the desgined digital filter
    figure;
    hold on; grid on;
    plot((w/(Ts*2*pi)),20*log10(abs(Hd_mag)/max(abs(Hd_mag))),'r','LineWidth',1,'MarkerSize',5);
